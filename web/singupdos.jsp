<%-- 
    Document   : singupdos
    Created on : 22/06/2017, 11:59:42 AM
    Author     : CESAR
--%>
	...
	<!-- //header -->
	 ...
	 <section>
		<div id="agileits-sign-in-page" class="sign-in-wrapper">
			...
			<h3>Registra Empresa</h3>
				<form name="registrar" id="registrar" method="POST" action="javascript:registroEmpresa()">
					<input type="text" id="nombreEmpresa" class="fadeIn second" name="nombreEmpresa" placeholder="Nombre Empresa">
                                        <input type="text" id="nit" class="fadeIn second" name="nit" placeholder="Nit">
                                        <input type="text" id="correoEmpresa" class="fadeIn second" name="correoEmpresa" placeholder="Correo Empresa">
                                        <input type="text" id="sector" class="fadeIn second" name="sector" placeholder="Sector">
