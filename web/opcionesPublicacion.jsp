<%-- 
    Document   : opcionesPublicacion
    Created on : 22/06/2017, 05:05:55 PM
    Author     : CESAR
--%>
					  ...
					  <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						<li role="presentation" class="active">
						  <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
							<span class="text">todas las empresas</span>
						  </a>
						</li>
						<li role="presentation" class="next">
						  <a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">
							<span class="text">Empresas que te interesen</span>
						  </a>
						</li>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							...
							<ul class="list">
                                                            ...
                                                            ArrayList<empresaDTO> empresas = nego.buscarEmpresastodas();
                                                                
                                                            for(empresaDTO empresa: empresas){
                                                            
                                                            %>
                                                            
								<a href="procesar/seleccionarEmpresa.jsp?nombre=<%=empresa.getNombreEmpresa()%>">
									<li>
									<img src="images/m1.jpg" title="" alt="" />
									<section class="list-left">
									<h5 class="title"><%=empresa.getNombreEmpresa()%></h5>
									<p class="catpath"><%=empresa.getSector()%></p>
									</section>
						...
						<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						 <div>
							...
							<ul class="list">
                                                            ...
                                                            ArrayList<empresaDTO> empresas2 = nego.buscarEmpresas(sector);
